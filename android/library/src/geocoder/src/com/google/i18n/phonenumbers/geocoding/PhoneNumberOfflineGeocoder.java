...
public class PhoneNumberOfflineGeocoder {
  ...
  // @VisibleForTesting
  PhoneNumberOfflineGeocoder(Context context, String phonePrefixDataDirectory) {
    phoneUtil = PhoneNumberUtil.getInstance(context);
   ...
   * geocoding.
   *
   * <p>This method of getInstance can only be used if PhoneNumberUtil.init() was called previously. Otherwise use
   * getInstance(context)
   *
  ...
  public static synchronized PhoneNumberOfflineGeocoder getInstance(Context context) {
    if (instance == null) {
      ...
      context = PhoneNumberUtil.getContext(); // The passed context can be null, so we get the initialized one
      if (context == null)
  ...
  /**
   * As per {@link #getDescriptionForValidNumber(Phonenumber.PhoneNumber, Locale)} but also considers the
  ...
  /**
   * As per {@link #getDescriptionForValidNumber(Phonenumber.PhoneNumber, Locale)} but explicitly checks
  ...
  /**
   * As per {@link #getDescriptionForValidNumber(Phonenumber.PhoneNumber, Locale, String)} but
