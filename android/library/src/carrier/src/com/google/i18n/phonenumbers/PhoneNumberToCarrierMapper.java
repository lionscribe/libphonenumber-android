...
public class PhoneNumberToCarrierMapper {
  ...
  PhoneNumberToCarrierMapper(String phonePrefixDataDirectory) {
    prefixFileReader = new PrefixFileReader(phoneUtil.getContext(), phonePrefixDataDirectory);
  }
   ...
   * {@link #getNameForValidNumber(Phonenumber.PhoneNumber, Locale)} but explicitly checks the validity of
